...
**Scope & mode:** de homepage-route `/`; Persuade (met evenwaardige Operate-plicht: speeluren in één oogopslag).
...
**Memorabel moment:** de rode vluchtbaan die zich bij het scrollen tekent van het kurkpunt in de hero tot in de zwarte slotsectie, met de vijf speelmomenten als meetpunten op de lijn.

**Constraints:** logo + clubrood bindend; warme nuchtere Vlaamse toon; geen verzonnen prijzen/testimonials; events-sectie moet gracieus wegvallen; statische Astro-build met base-prefix.

**Onopgelost:** fotopad (meer echte foto's van de oude site overnemen of grafisch blijven — beide toegestaan); overige pagina's migreren later naar deze wereld.
