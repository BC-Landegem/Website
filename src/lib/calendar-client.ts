...
// src/data/kalender.ts op en normaliseert ze tot CalendarItems. Bronnen die
// falen of leeg zijn worden stil genegeerd.
import { googleCalendarApiKey, sources, type CalendarSource } from '../data/kalender';
